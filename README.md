---
title: AI in the Industry Tutorials (RUL Estimation and Maintenance Policies)
author: michele.lombardi2@unibo.it
---

# Remaining Useful Life Estimation and Maintenance Policies #
...
This tutorial in particular addresses the estimation of the Remaining Useful Life (RUL) of industrial components, and how to implement maintenance policies based on RUL estimation. The tutorial show multiple techniques to formulate the policy design problem, and touches also the concept and use of neuro-probabilistic models.
